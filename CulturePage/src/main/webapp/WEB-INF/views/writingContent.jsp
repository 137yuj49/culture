			  ...
			  <div class="container">
				  ...
				  <form action="contentInsert.do">
			        ...
			        <div class="form-group">
					   ...
					   <input type="text" class="form-control" id="usr" name="bc_sabun">
					</div>
					<div class="form-group">
					   <label for="usr">제목</label>
					   <input type="text" class="form-control" id="title" name="bc_title">
					</div>									  				  
				    <div class="form-group">
				      <label for="comment">Comment:</label>
				      <textarea class="form-control" rows="5" id="comment" name="bc_content"></textarea>
				    </div>
				    <button type="submit" class="btn btn-primary btn-block" value="Register">글 등록</button>
				  </form>
			  </div>
