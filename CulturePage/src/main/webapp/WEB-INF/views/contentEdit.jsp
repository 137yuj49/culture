      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="preEdit.do">Edit Information</a>
          </div>
        </li>
        <li class="nav-item">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">UPDATE WRITING</li>
          </ol>
 
			  <!-- 추가한 부분 -->
			  <div class="container">
				  <h2>작성 글 수정</h2>
				  <p>사람이 책을 만들고 책이 사람을 만든다</p>
				  <form action="contentUpdate.do">
				  	<!-- 추가한 부분 -->
			        <div class="form-group">
					   <label for="usr">아이디</label>
					   <input type="text" class="form-control" id="bc_sabun" name="bc_sabun" value="${contentPreEdit.bc_sabun}" readonly="readonly">
					</div>
					<div class="form-group">
					   <label for="usr">제목</label>
					   <input type="text" class="form-control" id="bc_title" name="bc_title" value="${contentPreEdit.bc_title}" readonly="readonly">
					</div>									  				  
				    <div class="form-group">
				      <label for="comment">Comment:</label>
				      <textarea class="form-control" rows="5" id="bc_content" name="bc_content" >${contentPreEdit.bc_content}</textarea>
				    </div>
				    <button type="submit" class="btn btn-primary btn-block" value="Register">글 수정</button>
				  </form>
			  </div>
